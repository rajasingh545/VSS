           ...
           <div className="hrline">
             ...
             <div>
               <div className="row">
                 ...
                 <div className="col-sm-3 strong">{sizeList.text_scaffoldWorkType}</div>
               </div>
               <div className="row">
                 <div className="col-sm-3"><label>Scaffold Type:</label></div>
                 <div className="col-sm-3 strong">{sizeList.text_scaffoldType}</div>
               </div>
               <div className="row">
                 <div className="col-sm-3"><label>Scaffold Subcategory:</label></div>
                 <div className="col-sm-3 strong">{sizeList.text_scaffoldSubcategory}</div>
               </div>
               <div className="row">
                 <div className="col-xs-3"> L: <span className="strong">{sizeList.L}</span></div>
                 <div className="col-xs-3">W: <span className="strong">{sizeList.W}</span></div>
                 <div className="col-xs-3">H: <span className="strong">{sizeList.H}</span></div>

                 <div className="col-xs-3">Set <span className="strong">{sizeList.set}</span></div>
               </div>
             ...
             <div>
               <div className="row">
                 <div className="col-xs-3"><label>Safety</label></div><div className="col-xs-3 strong">{manpowerList.safety}</div>
                 <div className="col-xs-3"><label>Supervisor</label></div><div className="col-xs-3 strong">{manpowerList.supervisor}</div>
               </div>

               <div className="row">
                 <div className="col-xs-3"><label>Erectors</label></div><div className="col-xs-3 strong">{manpowerList.erectors}</div>
                 <div className="col-xs-3"><label>General Workers</label></div><div className="col-xs-3 strong">{manpowerList.gworkers}</div>
               </div>
