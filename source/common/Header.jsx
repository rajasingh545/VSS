        ...
        <Accordion allowMultipleOpen>
          {userType == 1 && (
            <div label="Work Arrangements">
              <a
                href="javascript:void(0);"
                onClick={() => this.goToUrl("/WorkArrangment")}
                style={styles2.sidebarLink}
              >
              ...
              <a
                href="javascript:void(0);"
                onClick={() => this.goToUrl("/WorkArrangmentList")}
                style={styles2.sidebarLink}
              >
                {" "}
                Work Arrangement List
              </a>
            </div>
          )}
          {userType == 5 && (
          ...
          <div label="Attendance">
            {(userType == 1 || userType == 5) && (
              <a
                href="javascript:void(0);"
                onClick={() => this.goToUrl("/Attendance")}
                style={styles2.sidebarLink}
              >
                {" "}
                Create Attendance
            ...
            {(userType == 1 || userType == 5) && (
              <a
                href="javascript:void(0);"
                onClick={() => this.goToUrl("/AttendanceList")}
                style={styles2.sidebarLink}
              >
                {" "}
                Attendance List
          ...
          {(userType == 1 || userType == 5) && (
            <div label="Work Request">
              <a
                href="javascript:void(0);"
                onClick={() => this.goToUrl("/WorkRequest")}
                style={styles2.sidebarLink}
              >
                {" "}
                Create Work Request
              ...
              <a
                href="javascript:void(0);"
                onClick={() => this.goToUrl("/WorkRequestList")}
                style={styles2.sidebarLink}
              >
                {" "}
                Work Request List
          ...
          {(userType == 1 || userType == 5) && (
            <div label="Daily Work Track">
              <a
                href="javascript:void(0);"
                onClick={() => this.goToUrl("/DailyWorkTrack")}
                style={styles2.sidebarLink}
              >
                Create DWTR
              </a>
              ...
              <a
                href="javascript:void(0);"
                onClick={() => this.goToUrl("/DailyWorkTrackList")}
                style={styles2.sidebarLink}
              >
                DWTR List
              </a>
          ...
          {userType == 1 && (
            <div label="Productivity Report">
              <a
                href="javascript:void(0);"
                onClick={() => this.goToUrl("/DWTRReport")}
                style={styles2.sidebarLink}
              >
                DWTR Report
              </a>
              <a
                href="javascript:void(0);"
                onClick={() => this.goToUrl("/Report-Supervisor")}
                style={styles2.sidebarLink}
              >
                Productivity Report by <br />
                Supervisor
              </a>

              <a
                href="javascript:void(0);"
                onClick={() => this.goToUrl("/Report-Sites")}
                style={styles2.sidebarLink}
              >
  ...
  render() {
    ...
    return (
      <div className="headerBK">
        <Sidebar {...sidebarProps} styles={this.state.panelStyle}></Sidebar>
