...
onItemChange = (key, list, stateKey, title) => {
  ...
  this.setState({ itemtitle: this.state.text_item, locationTitle: this.state.text_location, desc });
}
...
resetThenSet(key, list, stateKey, title) {
  ...
  onChangeProject = (key, list, stateKey, title) => {
    const clientsList = (this.state.clientsProjectMapping[key]) ? this.state.clients[key] : [];
