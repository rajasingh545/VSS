...
import WorkRequestPreviewPage from "pages/WorkRequestPeviewPage";
      ...
      <div className="mobileContainer">
        ...
        <div className="Page">
          <Switch>
            ...
            <Route
              exact
              path="/WorkRequestPreview/:id"
              component={WorkRequestPreviewPage}
            />
            <Route exact path="/WorkRequestList" component={WorkRequestList} />
            <Route exact path="/WorkArrangment" component={WorkArrangment} />
            <Route
              exact
              path="/WorkArrangment/:id"
              component={WorkArrangmentEdit}
            />
            <Route
              exact
              path="/WorkArrangmentList"
              component={WorkArrangmentList}
            />
            <Route exact path="/DailyWorkTrack" component={DailyWorkTrack} />
            <Route
              exact
              path="/DailyWorkTrackList"
              component={DailyWorkTrackList}
            />
            <Route
              exact
              path="/DailyWorkTrack/:id"
              component={DailyWorkTrackEdit}
            />
