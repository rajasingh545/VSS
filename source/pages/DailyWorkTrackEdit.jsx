...
resetThenSet(key, list, stateKey, title) {
  ...
  deleteMaterialItem = (index) => {
    if (this.materialList.length === 1) {
      ...
      this.materialList = this.materialList.filter((item) => item.uniqueId !== index);
    }
    this.setState({ materialList: this.materialList });
  }
  ...
  displayManpowerList = (teamList) => {
    return teamList.map((item, index) => {
      return (<TeamPreview index={ index } item={ item } onClose={ this.deleteTeamItem } />);
    });
  }

  displayMaterialList= (data) => {
    return data.map((item, index) => {
      return (<MaterialPreview index={ index } item={ item } onClose={ this.deleteMaterialItem } />);
    });
  }
  ...
  deleteWorkRequest = (index, subdivision) => {
    ...
    this.teamList = this.teamList.filter((item) => item.subdivision !== subdivision);
    this.materialList = this.materialList.filter((item) => item.subdivision !== subdivision);
  ...
  render() {
    ...
    return (
      <div className="container work-arr-container">
        ...
        <div>
          ...
          <div className="row ">
            <div className="col-xs-12">{this.state.itemList.length > 0 && this.displayWorkRequestList(this.state.itemList) }</div>
          </div>
        </div>
        }
    ...
    &nbsp;
        ...
        <div>
          ...
          <div className="row ">
            <div className="col-xs-12">{this.state.teamList.length > 0 && this.displayManpowerList(this.state.teamList) }</div>
          </div>
          ...
          <div className="row ">
            <div className="col-xs-12">{this.state.materialList.length > 0 && this.displayMaterialList(this.state.materialList) }</div>
          </div>
          ...
          <div className="row">
            ...
            <div className="col-sm-6 strong"><a target="_blank" href={ `${ imgURL }/${ this.state.disphoto_1 }` }><img src={ `${ imgURL }/${ this.state.disphoto_1 }` } height="100px" width="200px" /></a></div>
          </div>
    }
          {!this.state.disphoto_1 &&
          ...
          <div className="row">
            ...
            <div className="col-sm-6 strong"><a target="_blank" href={ `${ imgURL }/${ this.state.disphoto_2 }` }><img src={ `${ imgURL }/${ this.state.disphoto_2 }` } height="100px" width="200px" /></a></div>
          </div>
    }
          {!this.state.disphoto_2 &&
          <div className="row" style={ { paddingTop: '15px' } }>
          ...
          <div className="row">
            ...
            <div className="col-sm-6 strong"><a target="_blank" href={ `${ imgURL }/${ this.state.disphoto_3 }` }><img src={ `${ imgURL }/${ this.state.disphoto_3 }` } height="100px" width="200px" /></a></div>
          </div>
    }
          {!this.state.photo_3 &&
          <div className="row" style={ { paddingTop: '15px' } }>
